...
export const landingFruehstueck = {
  ...
  related: {
    ...
    afterItalienisch: ', a pranzo il ',
    lunchLink: 'business lunch e menu di mezzogiorno a Charlottenburg',
    afterLunch: ', con il sole la ',
    terrasseLink: 'terrazza sul Kudamm',
    afterTerrasse: ' e per il drink dopo il nostro ',
