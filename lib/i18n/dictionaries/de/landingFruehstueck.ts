...
export const landingFruehstueck = {
  ...
  related: {
    ...
    afterItalienisch: ', mittags der ',
    lunchLink: 'Business-Lunch und Mittagstisch in Charlottenburg',
    afterLunch: ', bei Sonne die ',
    terrasseLink: 'Terrasse am Kudamm',
    afterTerrasse: ' und für den Drink danach unsere ',
